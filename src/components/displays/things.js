...
export default function Things() {
	return <p>
		...
		<Tab/><span className="text-blue-800">*</span><Sp/>JavaScript<Sp/>(front<Sp/>and<Sp/>back)<Br/>
		...
		<Tab/><span className="text-blue-800">*</span><Sp/>OCaml<Sp/>(also<Sp/>ReasonML)<Br/>
		<Tab/><span className="text-blue-800">*</span><Sp/>Erlang<Sp/>(also<Sp/>Elixir<Sp/>...anything<Sp/>BEAM<Sp/>related<Sp/>really)<Br/>
		<Tab/><span className="text-blue-800">*</span><Sp/>Scala<Br/>
